...
export async function askQuestion(question: string, projectId: string) {
    ...
    (async () => {
        const {textStream} = await streamText({
            ...
            prompt: `
            You are a ai code assistant who answers questions about the codebase. your target audience is a technical intern who is looking to understand the code and its structure.
                AI assistant is a brand new, powerful, human-like artificial intelligence.
            The traits of AI include expert knowledge, helpfulness, cleverness, and articulatenes.
